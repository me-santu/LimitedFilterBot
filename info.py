...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'itz_Thanos') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "itz_Nehuuu") # ADMIN USERNAME
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Mk_Bot_Support')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://mammoth-truda-chiragbravrs-41390ac1.koyeb.app/")
