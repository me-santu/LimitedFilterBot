...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "7067885693").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "rpeditz_07"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "rpeditz_07")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002751966348").split()
]
